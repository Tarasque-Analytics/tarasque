...
In a former tool which i will post to the github eventually can be used as a research tool if the overnight tracker / autonomous model finds ticker/expiry combos that are statistically significant - which shows our best "deal" and a ton of other useful metrics including how to hedge 1000 USD worth of contract purchase. 
